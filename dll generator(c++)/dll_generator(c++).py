...
def main():
    ...
    command = command + " -o " + '\"' + out_path + "Victoria.dll\""

    #command = command + " & REM 2> errors.txt strip --strip-unneeded \"" + out_path + "Victoria.dll\" pause"###############################################
    if is_strip == True:
        command = command + " &  strip --strip-unneeded \"" + out_path + "Victoria.dll\""
